...
INSERT INTO roles (uuid, role_name, role_description, is_active, created_by, updated_by) VALUES
(UUID(), 'Super Admin', 'System administrator with full access', 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Admin', 'Company administrator', 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Doctor', 'Medical doctor', 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Nurse', 'Nursing staff', 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Receptionist', 'Front desk staff', 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Accountant', 'Accounting staff', 1, 'SYSTEM', 'SYSTEM');

-- Insert default menus
INSERT INTO menus (uuid, menu_name, menu_description, menu_path, menu_icon, menu_order, is_active, created_by, updated_by) VALUES
(UUID(), 'Dashboard', 'Main dashboard', '/dashboard', 'dashboard', 1, 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Patients', 'Patient management', '/patients', 'people', 2, 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Appointments', 'Appointment management', '/appointments', 'calendar', 3, 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Billing', 'Billing and payments', '/billing', 'payment', 4, 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Reports', 'Reports and analytics', '/reports', 'analytics', 5, 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Settings', 'System settings', '/settings', 'settings', 6, 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Users', 'User management', '/users', 'person', 7, 1, 'SYSTEM', 'SYSTEM');

-- Insert default plans
INSERT INTO plans (uuid, plan_name, plan_description, plan_type, price, currency, max_users, max_branches, is_active, created_by, updated_by) VALUES
(UUID(), 'Basic', 'Basic plan for small clinics', 'monthly', 5000.00, 'INR', 5, 1, 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Professional', 'Professional plan for hospitals', 'monthly', 15000.00, 'INR', 50, 5, 1, 'SYSTEM', 'SYSTEM'),
(UUID(), 'Enterprise', 'Enterprise plan for large hospitals', 'yearly', 200000.00, 'INR', NULL, NULL, 1, 'SYSTEM', 'SYSTEM');

-- Insert system settings
INSERT INTO hms_settings (company_id, setting_key, setting_value, setting_type, description) VALUES
(NULL, 'system.version', '1.0.0', 'system', 'System version'),
(NULL, 'system.maintenance_mode', 'false', 'system', 'Maintenance mode flag'),
(NULL, 'system.max_login_attempts', '5', 'system', 'Maximum login attempts before lockout'),
(NULL, 'system.lockout_duration', '30', 'system', 'Account lockout duration in minutes'),
(NULL, 'system.session_timeout', '120', 'system', 'Session timeout in minutes'),
(NULL, 'system.password_min_length', '8', 'system', 'Minimum password length'),
(NULL, 'system.password_require_special', 'true', 'system', 'Require special characters in password');